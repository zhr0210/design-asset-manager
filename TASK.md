...
- Remaining Windows evidence gaps: CLIP ONNX needs an app-owned ONNX artifact route before embedding can become `real_model_path`; Llama CUDA GGUF/mmproj still needs a real prompt/image validation path.
