...
export const macosAppleSiliconProfile: RuntimeProfile = {
  ...
  description: 'macOS arm64 profile for the macOS AI branch: Python MPS, ONNX Runtime, llama.cpp Metal, MLX, and external fallback.',
  platform: 'darwin',
  arch: 'arm64',
  requirements: ['macOS arm64', 'Writable app data paths'],
  capabilities: ['local-ai-worker', 'external-inference', 'ocr', 'tagging', 'embedding', 'runtime-package', 'python-mps', 'onnx-runtime', 'llama-metal', 'mlx', 'coreml', 'cpu-only'],
  ...
  optionalPackages: ['mlx-runtime', 'qwen3-vl-gguf', 'qwen3-vl-mlx', 'qwen2.5-vl-ollama-fallback'],
