...
assert.equal(manifest.autoStartWorker, false)
...
assert.match(realRunnerSource, /runProcess/)
...
assert.match(doc, /do not start a real Python process/i)
assert.match(doc, /Phase 11C/)
