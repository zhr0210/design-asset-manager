...
assert.match(signedWorkflow, /write-release-readiness-summary\.mjs/)
assert.match(signedWorkflow, /write-release-external-gate-status\.mjs/)
assert.match(signedWorkflow, /build\/release-branding\.json/)
assert.match(signedWorkflow, /release-branding-evidence-\*\.json/)
assert.match(signedWorkflow, /release-readiness-summary-\*\.json/)
assert.match(signedWorkflow, /release-external-gate-status-\*\.json/)
assert.match(signedWorkflow, /package-smoke-\*\.json/)
