...
assert.match(panelSource, /probePythonMpsRuntime/)
...
assert.match(panelSource, /getPythonMpsStatus: \(\) => Promise<AiRuntimeIpcResponse<AiRuntimePythonMpsStatusResponse>>/)
assert.match(panelSource, /getPythonCudaStatus: \(\) => Promise<AiRuntimeIpcResponse<AiRuntimePythonCudaStatusResponse>>/)
assert.match(panelSource, /probePythonMpsRuntime: \(\) => Promise<AiRuntimeIpcResponse<AiRuntimePythonMpsExecutionProbeResponse>>/)
assert.match(panelSource, /probePythonCudaRuntime: \(\) => Promise<AiRuntimeIpcResponse<AiRuntimePythonCudaExecutionProbeResponse>>/)
