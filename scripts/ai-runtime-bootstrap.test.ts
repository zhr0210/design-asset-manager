...
assert.match(bootstrapSource, /PYTHON_WORKER_AUTOSTART_PLATFORMS/)
assert.match(bootstrapSource, /AI_RUNTIME_APP_DATA_ROOT_ADAPTERS/)
...
assert.doesNotMatch(ipcSource, /PLATFORM_AI_BRANCH_RUNTIME_PROVIDER_DESCRIPTORS|PYTHON_WORKER_AUTOSTART_PLATFORMS|AI_RUNTIME_APP_DATA_ROOT_ADAPTERS/)
