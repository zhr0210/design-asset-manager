...
assert.match(plannerSource, /const hostContext = createLlamaRuntimeHostContext/)
assert.doesNotMatch(plannerSource, /process\.platform/)
assert.doesNotMatch(plannerSource, /process\.arch/)
assert.doesNotMatch(plannerSource, /os\.cpus|os\.totalmem/)
