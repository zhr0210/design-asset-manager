...
assert.match(bootstrapSource, /macos-ai-branch-runtime/)
assert.match(bootstrapSource, /createMacOSAiBranchRuntimeMetadata/)
...
const sharedTypesSource = await fs.readFile('src/shared/types/platform-ai-runtime.types.ts', 'utf8')
const macosTypesSource = await fs.readFile('src/shared/types/macos-ai-runtime.types.ts', 'utf8')
...
assert.match(macosTypesSource, /MacOSAiWorkerProbeResult extends PlatformAiWorkerProbeDiagnosticsInput/)
