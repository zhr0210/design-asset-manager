...
const generateStart = storeSource.indexOf('generateMockAiSuggestions: async')
...
assert.match(panelSource, /正在提交真实 AI Worker 打标任务/)
assert.match(panelSource, /正在等待真实模型返回/)
