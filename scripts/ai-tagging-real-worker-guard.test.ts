...
const textBoxProviderWorkflowSource = await fs.readFile('src/shared/workflows/text-box-provider.workflow.ts', 'utf8')
...
assert.doesNotMatch(aiConsoleSource, /<option value="mock">/)
...
assert.match(textBoxProviderWorkflowSource, /mock:\s*'none'/)
