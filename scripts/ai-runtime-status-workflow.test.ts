...
assert.match(macosAiRuntimeTypesSource, /MacOSAiWorkerProbeResult extends PlatformAiWorkerProbeResultBase/)
...
assert.match(windowsAiRuntimeTypesSource, /WindowsAiWorkerProbeResult extends PlatformAiWorkerProbeResultBase/)
